...
import { faAngleRight, faWandMagicSparkles } from '@fortawesome/free-solid-svg-icons';
        ...
        <section className="relative w-full bg-[#121212]">
            <div className="mx-auto max-w-7xl px-5 py-12 flex flex-col h-full">
                ...
                <div className='py-3 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10 my-3 items-center'>
                    <div className='mx-auto p-3 bg-[#191d24] max-w-[350px] flex-shrink-0 rounded-md'>
                        ...
                        <div className='flex flex-col justify-between bg-[#191d24] py-1 gap-2 text-white'>
                            <div className='flex flex-row gap-2 pt-2'>
                                <span className='text-[12px] font-[montserrat] text-yellow-200 border-[1px] border-yellow-200 rounded-full px-2'>python</span>
                            </div>
                    ...
                    <div className='p-3 bg-[#191d24] flex-shrink-0 rounded-md'>
                        <div className='h-[180px] p-3 bg-[#4a4e55] flex-shrink-0'></div>
                        <div className='h-[177px] p-3 bg-[#191d24] flex-shrink-0'></div>
                    </div>
                </div>
            <div className='flex items-center flex-col'>
